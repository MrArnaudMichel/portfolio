---
title: AIctron
description: "AIctron is an open-source project that allows you to predict data,
  from a given .csv dataset. Upload your file, choose the column to predict, and
  get the result in a few seconds. It's that simple! "
image:
  src: /images/projects/aictron/aictron1.png
authors:
  - name: Arnaud Michel
...
website: https://docs.aictron.arnaudmichel.fr/overview.html
git_repo: https://github.com/MrArnaudMichel/AIctron
role: Creator, Lead developper
main_language: Python, ReactJS
---
